...
class A2DComposition(tdata.Dataset):
	def __init__(self, args, transform=None, mode='train'):
		...
		self.actors_dict = {1: 'adult', 2: 'baby', 3: 'ball', 4: 'bird', 5: 'car', 6: 'cat', 7: 'dog'}
		...
		self.activations = dict(zip(activation_data['id'], activation_data['res']))
	...
	def get_split_info(self):
		...
		for index in range(csv_len):
			...
			for i in range(-self.args.t, self.args.t + 1):
				...
				t_img_path.append(os.path.join(self.args.a2d_root, 'pngs320H', video_name, t_img_name + '.png'))
